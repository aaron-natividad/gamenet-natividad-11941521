...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    // Sets room properties based on chosen options
    ...
    // Joins room based on chosen option rc / dr
    ...
    // Loads scene based on chosen gamemode
    ...
    public override void OnJoinedRoom()
    {
        ...
        GetComponent<PlayerSelection>().SetGameModePlayers((string)gameModeName);
